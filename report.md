...
| src/protocol/ThunderLoan.sol | 160 |
...
- Found in src/protocol/ThunderLoan.sol [Line: 220](src/protocol/ThunderLoan.sol#L220)
...
- Found in src/protocol/ThunderLoan.sol [Line: 146](src/protocol/ThunderLoan.sol#L146)

	```solidity
	        s_feePrecision = 1e18;
	```

- Found in src/protocol/ThunderLoan.sol [Line: 147](src/protocol/ThunderLoan.sol#L147)
